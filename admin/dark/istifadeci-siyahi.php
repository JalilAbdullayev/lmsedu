                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <a href="istifadeci-elave">
                                <button style="float: right;" class="btn btn-outline-primary">Əlavə et</button>
                            </a>
                                ...
                                <tbody>
                                    <?php for ($i = 0; $i < count($istifadeciler); $i++) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-outline-danger" onclick="DelUser(<?= $istifadeciler[$i]['id'] ?>)">
                                                    Sil
                                                </button>
                                            </td>
                                        </tr>
