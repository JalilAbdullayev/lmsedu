    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Kurslar Kateqoriyaları</h4>
                        <form class="mt-4" method="POST" action="#">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sira" class="form-control" id="KursSira"></select>
                                </div>
                                <button type="submit" class="btn btn-primary" name="kurskat">Əlavə Et</button>
                        </form>
                    </div>
                </div>
            </div>
