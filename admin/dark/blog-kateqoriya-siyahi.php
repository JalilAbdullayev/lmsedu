                                ...
                                <tbody>
                                    <?php for ($i = 0; $i < count($kdata); $i++) { ?>
                                        <tr class="blogcategoryedit">
                                            ...
                                            <td><?= $kdata[$i]["Ad"] ?></td>
                                            <td><?= $kdata[$i]["slug"] ?></td>
                                            <td><input type="checkbox" onchange="BlogKatStatus(<?= $kdata[$i]['id'] ?>)" <?= $kdata[$i]["status"] == 1 ? "checked" : ""; ?> class="js-switch" data-color="#33AFE3" data-size="small" /></td>
                                            <td>
                                                <button onclick="BlogKatRedakte(<?= $kdata[$i]['id'] ?>,<?= $i ?>)" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#exampleModal">Redaktə Et
                                                </button>
                                                <button onclick="DelBlogKat(<?= $kdata[$i]['id'] ?>)" class="btn btn-outline-danger btn-sm">Sil
                                                </button>
                                            </td>
                                        </tr>
                                    <?php } ?>
