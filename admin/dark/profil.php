                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-material">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="sekil"
                                                           id="inputGroupFile01">
                                                    <label class="custom-file-label" for="inputGroupFile01">(PNG,JPEG,GIF)
                                                        fayl seçin</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="password"
                                                       onkeyup="KohneSifre('<?= $_SESSION['user_email'] ?>',this.value)"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="password" onkeyup="SifreGucu()" id="yenisifre"
                                                       class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="password" onkeyup="SifreTekrarYoxla()" id="yenisifretekrar"
                                                       class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-success btnpass">Yenilə</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
