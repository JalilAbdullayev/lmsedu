                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="#" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="kateqoriya" id="kateqoriya">
                                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                                        <option value="<?= $data[$i]["id"] ?>" <?= $data[$i]["id"] == $rdk["kat_id"] ? 'selected="selected"' : ""; ?>><?= $data[$i]["Ad"] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="9999" name="qiymet" id="qiymet" class="form-control" placeholder="Qiymət Daxil edin" value="<?= $rdk["qiymet"] ?>" />
                            </div>
                            <div class="form-group">
                                <label>Şəkil</label>
                            ...
                            <button type="submit" class="btn btn-primary" name="kurs_redakte">Redaktə Et</button>
                        </form>
                    </div>
                </div>
            </div>
