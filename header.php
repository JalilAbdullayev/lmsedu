...
<div id="sidenav">
    ...
    <div class="btn-group">
        <a href="courses.php">
            <button type="button" class="btn btn-lg" style="color: white; font-weight: 200; font-size: 1em;">
                Kurslar
            </button>
        </a>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <?php foreach ($KursCat as $Cat) { ?>
                <a class="dropdown-item" href="course-<?= $Cat["slug"] . "-" . $Cat["id"] ?>">
                    <?= $Cat["Ad"] ?>
                </a>
            <?php } ?>
        </div>
    ...
    <div class="btn-group">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <?php foreach ($BlogCat as $Cat) { ?>
                <a class="dropdown-item" href="blog-<?= $Cat["slug"] . "-" . $Cat["id"] ?>">
                    <?= $Cat["Ad"] ?>
                </a>
            <?php } ?>
        </div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link"
                       style="font: 400 1em Roboto; letter-spacing: 0; line-height: 20px; color: #f2f7ff;"
                       href="index.php">
